...
Ps4To2600ControllerConverter::Ps4To2600ControllerConverter(std::map<std::string, std::string> userMap) :AXIS_DEADZONE{50}, TRIGGER_DEADZONE{100} {
        user_map = userMap;
}


void Ps4To2600ControllerConverter::convert(controller_t& input_controller, controller_t& output_controller)
{
        ...
        //BUTTON
        atari_2600_controller.button_states["BUTTON"] = compileButtonMappingsFor("BUTTON", ps4_controller);

        //D-PAD
        atari_2600_controller.button_states["D_UP"] = compileButtonMappingsFor("D_UP", ps4_controller);
        atari_2600_controller.button_states["D_DOWN"] = compileButtonMappingsFor("D_DOWN", ps4_controller);
        atari_2600_controller.button_states["D_RIGHT"] = compileButtonMappingsFor("D_RIGHT", ps4_controller);
        atari_2600_controller.button_states["D_LEFT"] = compileButtonMappingsFor("D_LEFT", ps4_controller);

}

int Ps4To2600ControllerConverter::compileButtonMappingsFor(std::string b, ps4_controller_t ps4) {
