...
XboxTo2600ControllerConverter::XboxTo2600ControllerConverter(std::map<std::string, std::string> userMap) :AXIS_DEADZONE{10000}, TRIGGER_DEADZONE{100} {
        user_map = userMap;
}

void XboxTo2600ControllerConverter::convert(controller_t& input_controller, controller_t& output_controller)
{
        atari_2600_controller_t& atari_2600_controller = (atari_2600_controller_t&) output_controller;
        xbox_controller_t& xbox_controller = (xbox_controller_t&) input_controller;

        //BUTTON
        atari_2600_controller.button_states["BUTTON"] = compileButtonMappingsFor("BUTTON", xbox_controller);

        //D-PAD
        atari_2600_controller.button_states["D_UP"] = compileButtonMappingsFor("D_UP", xbox_controller);
        atari_2600_controller.button_states["D_DOWN"] = compileButtonMappingsFor("D_DOWN", xbox_controller);
        atari_2600_controller.button_states["D_RIGHT"] = compileButtonMappingsFor("D_RIGHT", xbox_controller);
        atari_2600_controller.button_states["D_LEFT"] = compileButtonMappingsFor("D_LEFT", xbox_controller);

}

int XboxTo2600ControllerConverter::compileButtonMappingsFor(std::string b, xbox_controller_t xbox) {
