...
#ifndef XBOX_TO_7800_CONTROLLER_CONVERTER_H
#define XBOX_TO_7800_CONTROLLER_CONVERTER_H


class XboxTo7800ControllerConverter: public ControllerConverter {
    private:
        int AXIS_DEADZONE;
    ...
    public:
	XboxTo7800ControllerConverter(std::map<std::string, std::string> userMap);
